...
if (result.match != undefined) {
      ...
      if ( result.match.histogram != undefined) {  result.match.histogram='';};
      if ( result.match.codes != undefined) {  result.match.codes='';};
      if ( result.match.times != undefined) {  result.match.times='';};
};
...
exports.ingest = function(req, res) {
  ...
  console.log('parse'+parseInt(length, 10));
